...
public:
	...
	CAmount JSONGetAvailableCredit(bool fUseCache, std::string account) const;
...
public:
	...
	CAmount JSONGetBalance(const std::string& account) const;
	...
	CAmount JSONGetLegacyBalance(const isminefilter& filter, int minDepth, const std::string* account) const;
	...
	bool JSONGetKeyFromPool(CKey &key, int internal = 1);
